...
<html lang="en-US">
    <head>
		...
		.cabecalho {
			...
			margin-bottom: 30px;
			box-shadow: 0px 4px 18px -6px #333;
		}
		.branco { color: #FFFFFF; }
        </style>
                    ...
                    <div class="row-fluid">
                        <form class="form-inline">
                        	<div class="span2 bt-insere-enquete">
                        		<a id="bt-novaenquete" class="btn btn-info btn-large" href="novaenquete_unidade.php">Inserir enquete</a>
                                <input type="hidden" name="usuario" id="usuario" value="<?php echo $usuario; ?>" />
                            </div>
                            <div class="span10 filtro">
                            	<div class="div-interna-filtro1">Filtro:</div>
                                <div class="div-interna-filtro2">
                                    <select name="unidadeBusca" id="unidadeBusca" class="span10" <?php if($unidade != 'AM' && !empty($unidade)) echo 'disabled'; ?>>
