        ...
        <div class="container">
            ...
            <div class="row">
                ...
                <div class="span12">
                    ...
                    <div class="row">
                    	<?php
                        $busca = "SELECT id, titulo, unidade, (SELECT u.Nome FROM INF_unidades u WHERE u.IdUO = unidade) as nomeunidade, balcao, (SELECT b.Titulo FROM INF_balcoes b WHERE b.cod = balcao) as nomebalcao, ativo FROM CAD_enquete ORDER BY id";
						//echo $busca;
